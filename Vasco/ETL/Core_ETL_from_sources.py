...
ETL_logger = open("Vasco\ETL\ETL_log_15-45.txt", "w")
...
countries=iso_dic_code_is_key.keys()[16:45]
'''
In [24]: len(iso_dic)
Out[24]: 249
0-15 already done
...
for wb in wb_checkiftheyhave_list:
    ...
    if str(wb_raw_response) == '<Response [400]>':
        ...
        try:
            ...
            #these are most likely countries not in the wb database (French Guiana, Saint-Barthélemy)
